...
void drawrabbitthin1(int x, int y) {
	...
	gotoXY(x, y + 2);
	cout << "o/" << char(248) << char(248) << "/" << " o/" << char(248) << char(248) << "/" << " o/" << char(248) << char(248) << "/";
...
void drawrabbitthin2(int x, int y) {
	...
	gotoXY(x, y + 2);
	cout << "  \\" << char(248) << char(248) << "\\o" << "o/" << char(248) << char(248) << "/" << "  \\" << char(248) << char(248) << "\\o";
...
void drawrabbitthin3(int x, int y) {
	...
	gotoXY(x, y + 2);
	cout <<  "o/" << char(248) << char(248) << "/" << " o/" << char(248) << char(248) << "/" << "  \\" << char(248) << char(248) << "\\o";
...
void drawrabbitthin4(int x, int y) {
	...
	gotoXY(x, y + 2);
	cout << " o/ /" << char(248)<<" o/ /"<< char(248)<<" o/ /" << char(248);
